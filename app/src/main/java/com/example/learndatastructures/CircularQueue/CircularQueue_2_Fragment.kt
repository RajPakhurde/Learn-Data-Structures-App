...
import com.example.learndatastructures.databinding.FragmentCircularQueue2Binding
 ...
 * Use the [CircularQueue_2_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CircularQueue_2_Fragment : Fragment() {
    ...
    private lateinit var binding: FragmentCircularQueue2Binding
    var front = 0
    var rear = 0
    var once = 1
    ...
    override fun onCreateView(
        ...
        binding = FragmentCircularQueue2Binding.inflate(inflater,container,false)
    ...
    private fun deleteElement() {
        ...
        if (front == 7) {
            if (binding.tv1.text != "" && binding.tv1.text != null) {
                front = 0
            } else {
    ...
    companion object {
         ...
         * @return A new instance of fragment CircularQueue_2_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CircularQueue_2_Fragment().apply {
